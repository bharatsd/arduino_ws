...
namespace visp_tracker
{
  ...
  class MovingEdgeSites : public ros::Msg
  {
    ...
    MovingEdgeSites():
      header(),
      moving_edge_sites_length(0), st_moving_edge_sites(), moving_edge_sites(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "visp_tracker/MovingEdgeSites"; };
    virtual const char * getMD5() override { return "5293e8601467590a0dabbb34da47310c"; };
