...
namespace visp_tracker
{
  ...
  class KltPoints : public ros::Msg
  {
    ...
    KltPoints():
      header(),
      klt_points_positions_length(0), st_klt_points_positions(), klt_points_positions(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "visp_tracker/KltPoints"; };
    virtual const char * getMD5() override { return "681548d0f72044b7f086e3985d86f93c"; };
