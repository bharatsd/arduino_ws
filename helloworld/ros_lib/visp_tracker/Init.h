...
static const char INIT[] = "visp_tracker/Init";
  ...
  class InitRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return INIT; };
    virtual const char * getMD5() override { return "72f45c4391731722797b61d639ff8889"; };
  ...
  class InitResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return INIT; };
    virtual const char * getMD5() override { return "8e1a436e960986e0760f2970d0c88bf4"; };
