...
namespace visp_camera_calibration
{
  ...
  class ImageAndPoints : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "visp_camera_calibration/ImageAndPoints"; };
    virtual const char * getMD5() override { return "0fea5fc0844344ec4ec1adadebd18f75"; };
