...
namespace visp_camera_calibration
{
  ...
  class CalibPointArray : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "visp_camera_calibration/CalibPointArray"; };
    virtual const char * getMD5() override { return "46e7b53381d96d2d7cbbb7418f6dd696"; };
