...
namespace visp_camera_calibration
{
  ...
  class CalibPoint : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "visp_camera_calibration/CalibPoint"; };
    virtual const char * getMD5() override { return "9b9d41ff2127a593c07cec2a11858ac5"; };
