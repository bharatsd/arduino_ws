...
static const char CALIBRATE[] = "visp_camera_calibration/calibrate";
  ...
  class calibrateRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return CALIBRATE; };
    virtual const char * getMD5() override { return "7b57c459896a8f1f8df45a385acfc123"; };
  ...
  class calibrateResponse : public ros::Msg
  {
    ...
    calibrateResponse():
      stdDevErrs_length(0), st_stdDevErrs(), stdDevErrs(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return CALIBRATE; };
    virtual const char * getMD5() override { return "cd6d27af348dbd9b7530b010497f18b0"; };
